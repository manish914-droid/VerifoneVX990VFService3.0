...
class PendingPreauth(var context: Context) {
    ...
    private suspend fun checkReversalPerformPendingPreAuthTransaction(
        ...
        if (TextUtils.isEmpty(AppPreference.getString(AppPreference.GENERIC_REVERSAL_KEY))) {
            ...
            syncPreAuthTransactionToHost(transactionISOByteArray, cardProcessedDataModal, false) { syncStatus, responseCode, transactionMsg ->
                            ...
                            (context as BaseActivity).transactFragment(
                                ...
                                .apply {
                                    arguments = Bundle().apply {
                                        putSerializable("PreAuthData", pendingPreauthList as ArrayList<PendingPreauthData>)
                                        putSerializable("CardProcessData", cardProcessedDataModal)
                                    }
                                })
