...
class UnCaughtException(private val context: Context) : UncaughtExceptionHandler {
    ...
    private fun sendErrorMail(errorContent: StringBuilder?) {
        ...
        object : Thread() {
            override fun run() {
                ...
                builder.setMessage("Sorry for your inconvenience.Verifone Pos app has been stopped working , " +
    ...
    private fun forceStart(){
        ...
        val pendingIntent = PendingIntent.getActivity(VerifoneApp.appContext.applicationContext, 0, intent, PendingIntent.FLAG_ONE_SHOT)
        val alarmManager = VerifoneApp.appContext.applicationContext.getSystemService(Context.ALARM_SERVICE) as AlarmManager
