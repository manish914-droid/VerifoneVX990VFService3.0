...
class RecyclerViewUpdateUtils(oldBatchFileList: MutableList<BatchFileDataTable>, newBatchFileList: MutableList<BatchFileDataTable>)
    : DiffUtil.Callback() {
   ...
   init{
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
       return oldBatchList?.get(oldItemPosition)?.invoiceNumber == newBatchList?.get(newItemPosition)?.invoiceNumber
    }
