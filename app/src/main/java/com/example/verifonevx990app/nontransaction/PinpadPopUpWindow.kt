...
import com.example.verifonevx990app.vxUtils.VFService.vfIEMV
...
class PinpadPopUpWindow(context: Context, style: Int, var handler: Handler?, var cardProcessedDataModal: CardProcessedDataModal,var  title: String,var prompt: String) : Dialog(context,style),View.OnClickListener{
...
//                Log.d("TAG", data.toString());
            ...
            val ret = handler.post {
                ...
                try {
                 ...
                 var keyMap: MutableMap<String?, String?> =   vfPinPad?.initPinInputCustomView(2,param,pinKeys,pinInputListener) as MutableMap<String?, String?>
