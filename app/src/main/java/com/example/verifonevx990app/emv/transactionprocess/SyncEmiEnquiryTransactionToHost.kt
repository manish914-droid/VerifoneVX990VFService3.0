...
class SyncEmiEnquiryTransactionToHost(var transactionISOByteArray: IsoDataWriter?, var cardProcessedDataModal: CardProcessedDataModal? = null,
                ...
                try {
                    ...
                    if (success) {
                        ...
                        if (successResponseCode == "00") {
                            ...
                            VFService.showToast(
                                "Transaction Fail Error Code = ${responseIsoData.isoMap[39]?.parseRaw2String()
                                    .toString()}"
                            )
